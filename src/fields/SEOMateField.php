...
namespace vaersaagod\seomate\fields;

use vaersaagod\seomate\SEOMate;
use vaersaagod\seomate\assetbundles\seomatefieldfield\SEOMateFieldFieldAsset;
 ...
 * @since     1.0.0
 */
class SEOMateField extends Field
{
    // Public Properties
    // =========================================================================
    ...
    {
        return Craft::t('seomate', 'SEOMateField');
    }
    ...
    public function getSettingsHtml()
    {
        ...
        return Craft::$app->getView()->renderTemplate(
            'seomate/_components/fields/SEOMateField_settings',
            [
                'field' => $this,
            ]
        );
    ...
    public function getInputHtml($value, ElementInterface $element = null): string
    {
        ...
        Craft::$app->getView()->registerAssetBundle(SEOMateFieldFieldAsset::class);
        ...
        Craft::$app->getView()->registerJs("$('#{$namespacedId}-field').SEOMateSEOMateField(" . $jsonVars . ");");

        // Render the input template
        return Craft::$app->getView()->renderTemplate(
            'seomate/_components/fields/SEOMateField_input',
            [
                'name' => $this->handle,
                'value' => $value,
                'field' => $this,
