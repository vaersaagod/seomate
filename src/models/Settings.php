...
class Settings extends Model
{
    ...
    public $tagTemplateMap = [
        ...
        'og:title,og:description,og:image,og:image:width,og:image:height,og:image:alt,og:image:type,og:type,og:see_also,og:sitename,fb:app_id,fb:admins' => '<meta property="{{ key }}" content="{{ value }}">',
    ];
